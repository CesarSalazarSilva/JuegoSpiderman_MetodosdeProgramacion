...
//Función que ejecuta el recorrido manual de un juego nuevo.
...
void juegoNuevo(){
	...
	int caracter, fila, columna, verificador;
	...
	if (fila>10 || fila<0 || columna> 10 || columna<0){
		...
		if (matriz[fila][columna] == 0){
			printf("Error, por favor ingrese una coordenada que no corresponda a un '0' en el mapa");
		}else{
			do{
        			printf( "\n   1. Norte.");
        			printf( "\n   2. Sur.");
